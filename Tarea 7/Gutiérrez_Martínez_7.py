...
def main() -> None:
    # Variables comunes para la ejecución de los problemas
    ...
    while True:
        ...
        # Menú de opciones
        print('\t---- Tarea 7: Optimización por Enjambre de Partículas ----')
        ...
        if (ejecutar >= 0 and ejecutar < 4):
            ...
            for i in range(1, 4):
                ...
                for ejecucion in range(5):
                    ...
                    rango = problema.MAX_VALUE - problema.MIN_VALUE
                    v_max = rango * 0.01

                    # Instanciar el algoritmo de enjambre de particulas con el problema seleccionado
                    pso = PSO.PSO(cantidad_individuos, dimension, ro, phi1_max, phi2_max, v_max, problema, 2000)

                    # Obtener soluciones para el problema y almacenarlos en una lista
                    resultados.append(pso.run())
                ...
                promediosGeneracionales.append(((np.add.reduce(resultados)) / 5))
